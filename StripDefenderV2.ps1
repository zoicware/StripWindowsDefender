        ...
        elseif ($isoTextBox.Text -eq '' -or $destTextBox.Text -eq '') {
            ...
            if ($checkboxother.Checked) {
                ...
                foreach ($edition in $editions) {
                    ...
                    $radioButton.Text = $edition.ImageName
                ...
                $okButton.Add_Click({
                        ...
                        $editionTable.GetEnumerator() | ForEach-Object {
                            $editionName = $_.key
                            if ($editionName -eq $checkedButton.Text) {
                ...
                if ($checkboxPro.Checked) {
                    foreach ($edition in $editions) {
                        if ($edition.ImageName -like '*Pro*') {
                            $Script:editionNameR = $edition.ImageName
                            $Script:index = $edition.ImageIndex
                            break
                        }
                    }
                }
                    ...
                    #return home index
                    foreach ($edition in $editions) {
                        if ($edition.ImageName -like '*Home*') {
                            $Script:editionNameR = $edition.ImageName
                            $Script:index = $edition.ImageIndex
                            break
                        }
